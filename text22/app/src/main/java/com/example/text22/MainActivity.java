    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonAdd.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent = new Intent(MainActivity.this, com.example.text22.Add.class);
...
//                    startActivity(intent);
        ...
        ListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){      //配置ArrayList点击按钮
            ...
            public void  onItemClick(AdapterView<?> parent, View view , int position , long id){
                ...
                Intent intent = new Intent(MainActivity.this, com.example.text22.Edit.class);
